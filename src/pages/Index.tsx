              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">malenkiy.leo@yandex.ru</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+7 (921) 181-63-87</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Санкт-Петербург, Щербаков переулок 17/3</p>
                  </div>
                </div>
              </CardContent>
            </Card>
